...
def cache_headers(notion_api_key: str):
    headers = {"Authorization": f"Bearer secret_mUuQdT6VFWyw0cvWh9GZouE8Yz0ZyVDAT3cexT5YYs3", "Content-Type": "application/json",
...
with st.sidebar:
    openai_api_key = st.text_input(label='#### Your OpenAI API Key', placeholder="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", type="password")
    notion_api_key = st.text_input(label='#### Your Notion API Key', placeholder="secret_mUuQdT6VFWyw0cvWh9GZouE8Yz0ZyVDAT3cexT5YYs3",
                                 type="password")
